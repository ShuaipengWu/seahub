import { mediaUrl, gettext, serviceURL, siteRoot, enableFileComment, fileAuditEnabled, canGenerateShareLink, canGenerateUploadLink, username, folderPermEnabled } from './constants';
